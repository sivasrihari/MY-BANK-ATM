...
public void Login()
   {
    ...
    {
        System.out.println("Invalid Type Entry. Only NUmbers are allowed");
    ...
    public void getChecking()
        {
                ...
                switch(n)
                {
                    case 1:{System.out.println("Viewing Balance in your checking account: "+dec.format(checkCheckingBal()));
        ...
        public void getSaving()
        {
                ...
                switch(n)
                {
                    case 1:{System.out.println("Viewing Balance in your savings account: "+dec.format(checkSavingBal()));
                    try{Thread.sleep(3000);}
                    catch(InterruptedException e){}getAccountType();break;}
